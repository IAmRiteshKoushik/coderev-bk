...
export const checkProjectExist = async(projectName: string, email: string)
    : Promise<ProjectWithId | false | null> => {
    try {
        const filters = { email, projectName };
...
export const checkProjectExistId = async(projectId: string, email: string)
    : Promise<ProjectWithId | false | null> => {
    try {
